...
const Cardresultcarousel = (props) => {
  ...
  return (
    <div className=''>
        <div className="">
            <div className="mt-3 mx-6 md:mx-auto w-[300px] sm:w-auto">
              <div className="rounded-xl py-3 mr-5 bg-[#0F2434] font-poppins">
                ...
                <div className="pl-8 pt-3 text-[16px] font-semibold">
                  <p className="text-white">
                    <span className="pr-[19px] text-[#C6C8CC]">Amount</span> {stats?.block} SHIDO
                  </p>
                  <p className="text-white flex">
                    <span className="pr-[2.8rem] text-[#C6C8CC]">From</span> <div data-tooltip-id={stats?.from?.hash} onClick={() => copyText1(stats)}>{stats?.from?.hash?.slice(0,12)}...</div>
                    <ReactTooltip
                    id={stats?.from?.hash}
                    place="top"
                    className=""
                  ...
                  <p className="text-white flex">
                    <span className="pr-[4.2rem] text-[#C6C8CC]">To</span> <div data-tooltip-id={stats?.to?.hash} onClick={() => copyText2(stats)}>{stats?.to?.hash?.slice(0,12)}...</div>
                    <ReactTooltip
                    id={stats?.to?.hash}
                    place="top"
                    className=""
                  ...
                  <p className="text-white flex">
                    <span className="pr-[3rem] text-[#C6C8CC]">Hash </span> <div data-tooltip-id={stats?.hash} onClick={() => copyText3(stats)}>{stats?.hash?.slice(0,12)}...</div>
                    <ReactTooltip
                id={stats?.hash}
                place="top"
                className=""
